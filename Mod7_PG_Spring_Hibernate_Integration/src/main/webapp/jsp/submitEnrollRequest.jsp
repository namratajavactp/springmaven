...
<body background="images/background1.jpg">
	<div id="whole" align="center">
		...
		<div align="center">
			<form:form commandName="enrollRequest" method="POST" >
				<table
					...
					<tr>
						...
						<td><form:input path="city" id="textbox" /></td>
					</tr>
					<tr>
						<td><font color="white">state :</font></td>
						<td><form:input path="state" id="textbox" /></td>
					</tr>
					<tr>
						<td><font color="white">country :</font></td>
						<td><form:input path="country" id="textbox" /></td>
					</tr>
					<tr>
						<td><font color="white">Occupation :</font></td>
						<td><form:input path="custOccupation" id="textbox" /></td>
					</tr>
					<tr>
						<td><font color="white">Email :</font></td>
						<td><form:input path="custEmail" id="textbox" /></td>
					</tr>
					<tr>
